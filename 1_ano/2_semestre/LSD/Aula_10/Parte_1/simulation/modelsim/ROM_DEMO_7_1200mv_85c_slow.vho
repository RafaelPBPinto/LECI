...
-- Design Ports Information
-- CLOCK50	=>  Location: PIN_J14,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \u1|Mux7~0_combout\ = (\SW[0]~input_o\ & ((\SW[1]~input_o\) # ((\SW[2]~input_o\ & \SW[3]~input_o\))))
...
-- Equation(s):
-- \u1|Mux6~0_combout\ = (\SW[1]~input_o\ & (!\SW[0]~input_o\ & ((!\SW[3]~input_o\) # (!\SW[2]~input_o\))))
...
-- Equation(s):
-- \u1|Mux5~0_combout\ = (!\SW[1]~input_o\ & (\SW[0]~input_o\ & ((!\SW[3]~input_o\) # (!\SW[2]~input_o\))))
...
-- Equation(s):
-- \u1|Mux4~0_combout\ = (\SW[1]~input_o\) # ((\SW[0]~input_o\) # ((\SW[2]~input_o\ & \SW[3]~input_o\)))
...
-- Equation(s):
-- \u1|Mux0~0_combout\ = (\SW[0]~input_o\ & (\SW[1]~input_o\ $ (((\SW[2]~input_o\ & \SW[3]~input_o\)))))
