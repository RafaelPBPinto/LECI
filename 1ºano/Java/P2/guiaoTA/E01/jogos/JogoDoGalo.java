...
public class JogoDoGalo {
  ...
  public void mostraResultado(int vitoriao, int vitoriax, int derrotao, int derrotax, int empate) {
    out.println();
    out.println("Jogador | Vitórias | Derrotas | Empates");
    out.printf ("X       |    %d     |     %d    |    %d  ", vitoriax, derrotax, empate);
    out.printf ("\nO       |    %d     |     %d    |    %d  ", vitoriao, derrotao, empate);
    out.println();
  }
