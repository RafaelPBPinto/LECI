...
public class LinkedList<E> {
  ...
  private Node<E> get(Node<E> n, int pos) {
    if(n == null){
      return n;
    }else{
  ...
  private LinkedList concatenate(Node<E> n, LinkedList<E> lst){
    if(n == null){
      return lst;
    }else{
			LinkedList<E> x = this.concatenate(n.next, lst);
			x.addFirst(n.elem);
			return x;
		}
  }
