...
/*EX2- INSERT DATA INTO GESTSTOCK*/

INSERT INTO GESTSTOCK_tipo_fornecedor([codigo],[designacao])
VALUES
(101, 'Carnes'),
(102, 'Laticinios'),
...
INSERT INTO GESTSTOCK_fornecedor([nif], [nome], [fax], [endereco], [condpag], [tipo])
VALUES
...
INSERT INTO GESTSTOCK_produto(codigo, nome, preco, iva, unidades)
VALUES
...
INSERT INTO GESTSTOCK_encomenda([numero], [data], [fornecedor])
VALUES
...
INSERT INTO GESTSTOCK_item([numEnc], [codProd], [unidades])
VALUES
(1, 10001, 200),
(1, 10004, 300),
(2, 10002, 1200),
